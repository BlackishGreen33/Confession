...
export function normalizeNvidiaModel(model: string | undefined): string | undefined {
  if (model !== 'deepseek-ai/deepseek-r1') return model
  return 'qwen/qwen2.5-coder-32b-instruct'
}

export async function loadRuntimeLlmConfigFromStorage(): Promise<LlmClientConfig | undefined> {
