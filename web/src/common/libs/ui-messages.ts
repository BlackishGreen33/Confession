...
const SYNC_PHASE_LABELS: Record<
  ResolvedLocale,
  Record<SyncPhaseMessage, string>
> = {
  'zh-TW': {
    idle: '未儲存',
...
const ENGINE_MODE_LABELS: Record<
  ResolvedLocale,
  Record<ScanEngineMode, string>
> = {
  'zh-TW': {
    agentic: '智慧多代理分析',
    baseline: '基準分析引擎',
  ...
  en: {
    agentic: 'Agentic Multi-Agent Analysis',
