...
import { buildSecuritySummaryFromContext } from './dashboard-summary'
...
export interface SecuritySummaryContext {
...
export function buildSecuritySummary(
  ...
  return buildSecuritySummaryFromContext(context, locale)
}
